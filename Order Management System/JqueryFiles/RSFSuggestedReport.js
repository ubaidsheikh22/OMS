...
function getConfirmedOrderData() {
    ...
    $("#RSFSuggestedReport").DataTable().destroy();
    var table = $("#RSFSuggestedReport").DataTable({
        dom: 'Bfrtip',
        buttons: [
            'excel', 'csv', 'print'
        ],
        "ajax": {
            "url": "RSFSuggestedReport",
            "type": "GET",
            "data": {
                ...
                MatGrp2: drpMatGrp2, MatGrp3: drpMatGrp3, MatGrp4: drpMatGrp4, StartDate: StartDate
            },
