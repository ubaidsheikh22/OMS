...
function getConfirmedOrderData() {
    ...
    $("#CustomizeOrdersWithRSFTable").DataTable().destroy();
    var table = $("#CustomizeOrdersWithRSFTable").DataTable({
        dom: 'Bfrtip',
        buttons: [
            'excel', 'csv', 'print'
        ],
        "ajax": {
            "url": "GetCustomizeOrdersReportWithRSF",
            "type": "GET",
            "data": {
        ...
        "columns": [
            ...
            { "data": "monthlyRSF", "class": "monthlyRSF", "name": "monthlyRSF", "autoWidth": true },
            { "data": "weeklyrsf", "class": "weeklyrsf", "name": "weeklyrsf", "autoWidth": true },
            { "data": "suggestedOrder", "class": "suggestedOrder", "name": "suggestedOrder", "autoWidth": true },
